...
public class SnippetStatusListenerTest extends KullaTesting {
    ...
    public void testTwoSnippetEventListeners() {
        ...
        Assertions.assertEquals(listener2.getEvents(), events1, "Checking got events");
        ...
        assertEvalException("throw new RuntimeException();");
        Assertions.assertEquals(events1, listener1.getEvents(), "Checking that unsubscribed listener does not get events");

        List<SnippetEvent> events2 = new ArrayList<>(listener2.getEvents());
        events2.removeAll(events1);

        Assertions.assertEquals(3, events2.size(), "The second listener got events");
    }
    ...
    public void testSubscriptionToAnotherState() {
        ...
        setUp();
        assertEval("int x;");
        Assertions.assertEquals(listener.getEvents(), Collections.emptyList(), "No events");
