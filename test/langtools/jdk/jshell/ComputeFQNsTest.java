...
public class ComputeFQNsTest extends KullaTesting {
    ...
    public void testSuspendIndexing() throws Throwable {
        ...
        Assertions.assertEquals(Arrays.asList(), candidates.getNames(), "Input: " + code + ", candidates=" + candidates.getNames());
        Assertions.assertEquals(false, candidates.isUpToDate(), "Input: " + code + ", up-to-date=" + candidates.isUpToDate());
        ...
        Assertions.assertEquals(Arrays.asList("test.FQNTest"), candidates.getNames(), "Input: " + code + ", candidates=" + candidates.getNames());
        Assertions.assertEquals(candidates.isUpToDate(), true, "Input: " + code + ", up-to-date=" + candidates.isUpToDate());
    }
