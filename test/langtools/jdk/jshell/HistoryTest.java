...
public class HistoryTest extends ReplToolTesting {
    ...
    public void testReadExistingHistory() {
        ...
        Assertions.assertEquals("/debug 0", prefsMap.get("HISTORY_LINE_00"));
        Assertions.assertEquals("void test() {\\", prefsMap.get("HISTORY_LINE_01"));
        Assertions.assertEquals("    System.err.println(1);\\", prefsMap.get("HISTORY_LINE_02"));
        Assertions.assertEquals("    System.err.println(`\\\\\\\\\\", prefsMap.get("HISTORY_LINE_03"));
        Assertions.assertEquals("    \\\\\\", prefsMap.get("HISTORY_LINE_04"));
        Assertions.assertEquals("`);\\", prefsMap.get("HISTORY_LINE_05"));
        Assertions.assertEquals("} //test", prefsMap.get("HISTORY_LINE_06"));
        Assertions.assertEquals("/debug 0", prefsMap.get("HISTORY_LINE_07"));
        Assertions.assertEquals("int i", prefsMap.get("HISTORY_LINE_08"));
        Assertions.assertEquals("/exit", prefsMap.get("HISTORY_LINE_09"));
    ...
    private void previousAndAssert(History history, String expected) {
        Assertions.assertTrue(history.previous());
        Assertions.assertEquals(expected, history.current().toString());
    }
