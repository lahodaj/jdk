...
public class MethodsTest extends KullaTesting {
    ...
    ***/
    ...
    public void methodsAbstract() {
        ...
        Assertions.assertEquals(                List.of("method f()"), getState().unresolvedDependencies(m1).collect(Collectors.toList()));
        ...
        Assertions.assertEquals(2, unr.size());
        unr.remove("class Blah");
        unr.remove("method mm(Blah)");
        Assertions.assertEquals(0, unr.size(), "unexpected entry: " + unr);
    ...
    public void testMethodArrayParameters() {
        ...
        Assertions.assertEquals("int...", m1.parameterTypes());
        MethodSnippet m2 = methodKey(assertEval("void m2(int[]... p) { }", added(VALID)));
        Assertions.assertEquals("int[]...", m2.parameterTypes());
        MethodSnippet m3 = methodKey(assertEval("void m3(int[][] p) { }", added(VALID)));
        Assertions.assertEquals("int[][]", m3.parameterTypes());
    }
