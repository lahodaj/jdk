...
/*
 * @test
 * @summary Test features provided by the MethodHandleCarriers class.
 * @modules java.base/java.lang.runtime
 * @enablePreview true
 * @compile --patch-module java.base=${test.src} MethodHandleCarriersTest.java
 * @run main/othervm --patch-module java.base=${test.class.path} java.lang.runtime.MethodHandleCarriersTest
 */
...
public class MethodHandleCarriersTest {
    ...
    static void primitivesTest() throws Throwable {
        ...
        MethodHandle constructor = MethodHandleCarriers.initializingConstructor(methodType);
    ...
    private static List<MethodHandle> components(MethodType methodType) {
        ...
        for (int i = 0; i < methodType.parameterCount(); i++) {
            result.add(MethodHandleCarriers.component(methodType, i));
        }
        return result;
    }
    ...
    static void invoker() throws Throwable {
        ...
        Object[] result = (Object[])
            MethodHandleCarriers.componentInvoker(methodType)
    ...
    static void boxedArray() throws Throwable {
        ...
        Object carrier = constructor.invokeExact(-1, "test");
        Object[] result = (Object[])
            MethodHandleCarriers.boxedComponentValueArray(methodType)
                         .invoke(carrier);
        assertTrue(Objects.equals(-1, result[0]), String.valueOf(result[0]));
        assertTrue(Objects.equals("test", result[1]), String.valueOf(result[1]));
    }
