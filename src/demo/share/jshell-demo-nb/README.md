...
This is a demo plugin for NetBeans, showing enhanced JShell code completion.
...
- have a NetBeans build ready; lets mark the directory with NetBeans `NETBEANS_DIR`
- build and run this demo:
```
$ ant -Dnbplatform.default.netbeans.dest.dir=$NETBEANS_DIR -Dnbplatform.default.harness.dir=$NETBEANS_DIR/harness -Dnbjdk.home=$JDK_IMAGE run
```
