 ...
 */
public final class ArrayCarriers {
    ...
    static {
        try {
            ...
            CONSTRUCTOR = lookup.findStatic(ArrayCarriers.class, "constructor", MethodType.methodType(Object.class, Object[].class));
            COMPONENT_GETTER = lookup.findStatic(ArrayCarriers.class, "componentGetter", MethodType.methodType(Object.class, int.class, Carrier.class));
            CARRIER_INVOKER = lookup.findStatic(ArrayCarriers.class, "carrierInvoker", MethodType.methodType(Object.class, MethodHandle.class, Carrier.class, MethodHandle.class));
    ...
    public static MethodHandle component(MethodType methodType, int i) {
        return MethodHandles.insertArguments(COMPONENT_GETTER, 0, i).asType(MethodType.methodType(methodType.parameterType(i), Object.class));
    }
    ...
    public static MethodHandle componentInvoker(MethodType methodType) {
        ...
        return MethodHandles.insertArguments(CARRIER_INVOKER, 0, invoker).asType(MethodType.methodType(Object.class, Object.class, MethodHandle.class));
    }

    private static Object carrierInvoker(MethodHandle invoker, Carrier carrier, MethodHandle reader) throws Throwable {
        return MethodHandles.insertArguments(invoker, 1, carrier.data()).invoke(reader);
    }
