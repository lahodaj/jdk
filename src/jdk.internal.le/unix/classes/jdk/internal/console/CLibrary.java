    ...
    static class winsize {
        ...
        static {
            LAYOUT = MemoryLayout.structLayout(
                    ...
                    ValueLayout.JAVA_SHORT);
            ws_row = lookupVarHandle(LAYOUT, MemoryLayout.PathElement.groupElement("ws_row"));
            ws_col = lookupVarHandle(LAYOUT, MemoryLayout.PathElement.groupElement("ws_col"));
        }
    ...
    static class termios {
        ...
        static {
            ...
            c_iflag = adjust2LinuxHandle(
                    lookupVarHandle(LAYOUT, MemoryLayout.PathElement.groupElement("c_iflag")));
            c_oflag = adjust2LinuxHandle(
                    lookupVarHandle(LAYOUT, MemoryLayout.PathElement.groupElement("c_oflag")));
            c_cflag = adjust2LinuxHandle(
                    lookupVarHandle(LAYOUT, MemoryLayout.PathElement.groupElement("c_cflag")));
            c_lflag = adjust2LinuxHandle(
                    lookupVarHandle(LAYOUT, MemoryLayout.PathElement.groupElement("c_lflag")));
            c_cc_offset = LAYOUT.byteOffset(MemoryLayout.PathElement.groupElement("c_cc"));
            c_ispeed = adjust2LinuxHandle(
                    lookupVarHandle(LAYOUT, MemoryLayout.PathElement.groupElement("c_ispeed")));
            c_ospeed = adjust2LinuxHandle(
                    lookupVarHandle(LAYOUT, MemoryLayout.PathElement.groupElement("c_ospeed")));
        }
