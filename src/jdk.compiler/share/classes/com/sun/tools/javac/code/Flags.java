...
public class Flags {
    ...
    /* Standard Java flags.
     */
    @Use({FlagTarget.TREE, FlagTarget.METHOD, FlagTarget.TYPE, FlagTarget.VARIABLE})
    ...
    @Use({FlagTarget.TREE, FlagTarget.METHOD})
    public static final int SYNCHRONIZED = 1<<5;
    @Use({FlagTarget.TREE, FlagTarget.VARIABLE})
    public static final int VOLATILE     = 1<<6;
    @Use({FlagTarget.TREE, FlagTarget.VARIABLE})
    public static final int TRANSIENT    = 1<<7;
    @Use({FlagTarget.TREE, FlagTarget.METHOD})
    public static final int NATIVE       = 1<<8;
    @Use({FlagTarget.TREE, FlagTarget.TYPE})
    public static final int INTERFACE    = 1<<9;
    @Use({FlagTarget.TREE, FlagTarget.METHOD, FlagTarget.TYPE})
    ...
    @Use({FlagTarget.TREE, FlagTarget.TYPE, FlagTarget.VARIABLE})
    ...
    public static final long HASINIT          = 1L<<40;
     ...
     */
    @Use({FlagTarget.METHOD, FlagTarget.TREE}) //XXX: on trees?
     ...
     */
    @Use({FlagTarget.METHOD, FlagTarget.TREE})
    public static final long BRIDGE          = 1L<<31;

    /** Flag that marks formal parameters.
     */
    @Use({FlagTarget.VARIABLE, FlagTarget.TREE})
     ...
     */
    @Use({FlagTarget.METHOD, FlagTarget.TREE, FlagTarget.TYPE})
     ...
     */
    @Use({FlagTarget.METHOD})
    public static final long SIGNATURE_POLYMORPHIC = 1L<<47;
     ...
     */
    @Use({FlagTarget.TYPE, FlagTarget.TREE})
     ...
     */
    @Use({FlagTarget.TYPE})
    public static final long TYPE_TRANSLATED = 1L<<49;
     ...
     */
    @Use({FlagTarget.TYPE})
    public static final long HAS_RESOURCE = 1L<<62; //PackageSymbols only

    /**
     * Flag to indicate the given ParamSymbol has a user-friendly name filled.
     */
    @Use({FlagTarget.TREE, FlagTarget.VARIABLE})
    public static final long NAME_FILLED = 1L<<46; //ParamSymbols only
     ...
     */
    @Use({FlagTarget.TYPE})
    public static final long VALUE_BASED = 1L<<60; //ClassSymbols only
     ...
     */
    @Use({FlagTarget.TREE})
    public static final long BODY_ONLY_FINALIZE = 1L<<18; //blocks only
     ...
     */
    @Use({FlagTarget.VARIABLE})
    public static final long MATCH_BINDING = 1L<<45;
     ...
     */
    @Use({FlagTarget.TYPE, FlagTarget.VARIABLE, FlagTarget.METHOD, FlagTarget.TREE})
     ...
     */
    @Use({FlagTarget.METHOD, FlagTarget.TREE})
    public static final long COMPACT_RECORD_CONSTRUCTOR = 1L<<50;
     ...
     */
    @Use({FlagTarget.METHOD, FlagTarget.VARIABLE, FlagTarget.TREE})
    public static final long GENERATED_MEMBER = 1L<<32;
     ...
     */
    @Use({FlagTarget.VARIABLE}) //parameters only
     ...
     */
    @Use({FlagTarget.TREE, FlagTarget.VARIABLE})
    public static final long FIELD_INIT_TYPE_ANNOTATIONS_QUEUED = 1L<<20;
    ...
    @NotFlag
    public static final long TREE_FLAGS = FlagsEnum.TREE_FLAGS;
    ...
    public enum FlagTarget {
        /** This flag can appear on an AST node (typically in JCModifier).
         *  This bit mask cannot have different meaning for different Symbol
         *  kinds.
         */
        TREE,
