...
public class Attr extends JCTree.Visitor {
    ...
    protected Attr(Context context) {
        ...
        allowConstantPatterns = preview.isEnabled() && Feature.CONSTANT_PATTERNS.allowedInSource(source);
    }
    ...
    /** Are constant patterns allowed.
     */
    private final boolean allowConstantPatterns;
            ...
            for (List<JCCase> l = cases; l.nonEmpty(); l = l.tail) {
                ...
                for (List<JCCaseLabel> labels = c.labels; labels.nonEmpty(); labels = labels.tail) {
                    ...
                    if (label instanceof JCConstantCaseLabel constLabel) {
                        ...
                        if (allowConstantPatterns) {
                            //only produce this warning when constant patterns are enabled for now,
                            //as there are multiple constants in java.base, java.xml and other modules triggering the warning
                            //it needs to be seen what we'll do about those:
